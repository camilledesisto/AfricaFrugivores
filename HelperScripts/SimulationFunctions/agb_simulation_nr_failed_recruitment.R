agb_simulation_nr <- function(plot){
...
agb_simulation_draws_nr <- function(FUNCTION_NAME){
  ...
  j
  write.csv(Plot_simulation, file=paste0(x=save_path, "total/no_redundancy/", j, ".csv"))
